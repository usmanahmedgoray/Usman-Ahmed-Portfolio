...
const HireMe = () => {
  return (
    <div className='fixed left-20 bottom-24 flex items-center justify-center md:right-16 md:left-auto md:top-12 md:bottom-auto md:absolute overflow-hidden'>
